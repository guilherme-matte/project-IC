...
//    private ContribuinteModel contribuinteModel;
    ...
    public ResponseEntity<ApiResponseDTO> calcularAtivo(FiiModel fiiModel, String cpf) {
        ...
        Double variacao = precoMedio / precoAtual;
        ...
        return response.response(calculoAtivo, "Calculo realizado com sucesso!", 200);
    }
